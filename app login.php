...
$ret=mysqli_query($con,"SELECT * FROM apprenant WHERE nom='".$_POST['username']."' and password='".$_POST['password']."'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="entete.html"><h2>Connexion Apprenant</h2></a>
				</div>

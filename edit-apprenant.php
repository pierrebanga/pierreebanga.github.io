...
$query=mysqli_query($con,"update apprenant set telephone='$tel',ville='$ville',quartier='$quartier',
						...
						<section id="page-title">
							<div class="row">
								...
								<ol class="breadcrumb">
									...
									<li class="active">
										<span>Detail de l'apprenant</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">modifier l'apprenant</h5>
												</div>
...
<div class="form-group">
	...
	<input type="text" name="mensualite" class="form-control" placeholder="votre nouvelle Mensualité"/>
														</div>

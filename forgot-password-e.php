...
$email=$_POST['email'];
$query=mysqli_query($con,"select id_e from  enseignant where telephone='$telephone' and email='$email'");
$row=mysqli_num_rows($query);
if($row>0){

$_SESSION['telephone']=$telephone;
$_SESSION['email']=$email;
header('location:reset-password-e.php');
} else {
echo "<script>alert('Informations incorrect,veuillez reesayer s'il vous plait');</script>";
echo "<script>window.location.href ='forgot-password-e.php'</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2>Restauration du Mot de passe</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Restauration du Mot de passe de l'enseignant
							</legend>
							<p>

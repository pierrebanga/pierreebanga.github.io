...
$query=mysqli_query($con,"insert into apprenant(nom,prenom,password,date_naissance,telephone,photo,sexe,email,mensualiter,rue,quartier,ville,niveau_scolaire,matiere_solliciter) 
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();" enctype="multipart/form-data">
						<fieldset>
							<legend>
								Inscrivez vous
							</legend>
                          ...
                          <div class="form-group"> </div>
							...
							<div class="form-group">
								...
								<div class="clip-radio radio-primary">
									<input type="radio" id="rg-female" name="sexe" value="masculin" >
									<label for="rg-female">
										Féminin
									</label>
									<input type="radio" id="rg-male" name="sexe" value="feminin">
									<label for="rg-male">
										Masculin
									</label>
								</div>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control"  id="password_again" name="confirmer" placeholder="Confirmer le mot de passe" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" id="submit" name="submit" value="valider">
